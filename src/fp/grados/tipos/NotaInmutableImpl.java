...
public final class NotaInmutableImpl implements Nota {
	...
	private final Boolean mencion;
	private final Double valor;

	/***************************************************
	 * CONSTRUCTOR 1
	 *************************************************/
	public NotaInmutableImpl(Asignatura asig, Integer curso, Convocatoria convocatoria, Double valor, Boolean mencion) {

		checkValor(valor);
		checkMatricula(valor, mencion);

		this.asig = copia(asig);
		this.curso = curso;
	...
	public NotaInmutableImpl(Asignatura asig, Integer curso, Convocatoria convocatoria, Double valor) {
		checkValor(valor);
	...
	private Asignatura copia(Asignatura asignatura) {
		return new AsignaturaImpl(asignatura.getNombre(), asignatura.getCodigo(), asignatura.getCreditos(),
				asignatura.getTipo(), asignatura.getCurso(), asignatura.getDepartamento());
	}
