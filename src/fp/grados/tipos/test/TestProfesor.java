...
public class TestProfesor {
	...
	private static void nuevaTutoria(Profesor p, LocalTime horaComienzo, Integer duracionMinutos, DayOfWeek dia) {

		try {

			System.out.println("Se va a crear una nueva tutoria");
			...
			p.nuevaTutoria(horaComienzo, duracionMinutos, dia);
			System.out.println("La lista de tutorias es " + p.getTutorias());
